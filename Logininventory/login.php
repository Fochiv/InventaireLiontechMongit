<?php
/* ============================================================
   login.php — Tally Business Manager
...
<head>
    ...
    <meta name="description" content="Tally Business Manager — connexion sécurisée.">
...
<div class="lt-root">
  ...
  <div class="lt-receipt-banner">
    ...
    <a class="lt-receipt-btn" href="<?= APP_URL ?>/Vente_cashier/Client/client.php">
      View receipt <span class="lt-receipt-btn-fr">/ Voir mon reçu</span>
    </a>
  </div>
  ...
  <div class="lt-page">
    ...
    <aside class="lt-left" aria-hidden="true">
      ...
      <div class="lt-logo">
        <img src="<?= APP_URL ?>/Image/TALLYLOGO.png" alt="Tally" class="lt-logo-img"/>
        <div class="lt-logo-text">
          <div class="lt-logo-name">Tally</div>
          <div class="lt-logo-tag">Powered by <span class="lt-logo-brand">LionTech</span></div>
        </div>
      </div>

      <h1 class="lt-left-title" data-lt="welcome">Welcome to Tally</h1>
      <p class="lt-left-sub" data-lt="welcome_sub">The all-in-one platform designed for African businesses of every size.</p>
      ...
      <div class="lt-left-footer">© 2026 Tally · Powered by LionTech. All rights reserved.</div>
    </aside>
    ...
    <main class="lt-right" role="main">
      ...
      <div class="lt-mobile-logo">
        <img src="<?= APP_URL ?>/Image/TALLYLOGO.png" alt="Tally" style="width:60px;height:60px;object-fit:contain;"/>
        <div class="lt-mobile-logo-name">Tally Business Manager</div>
        <p class="lt-mobile-logo-sub" data-lt="app_subtitle">Manage your business, inventory, employees, and reports — all in one place.</p>
      </div>

      <div class="lt-card">
        <h2 class="lt-card-title" data-lt="login_title">Sign In to Your Account</h2>
        <p class="lt-card-sub">Tally Business Manager</p>
        ...
        <form id="lt-form" method="POST" action="auth.php" novalidate autocomplete="on">
          ...
          <div class="lt-form-group">
            ...
            <div class="lt-input-wrap">
              <input type="text" id="lt-login-id" name="login_id" class="lt-input"
                placeholder="Email, phone, username or employee code"
                autocomplete="username" autocapitalize="none" autocorrect="off"
                spellcheck="false" required aria-required="true"/>
            </div>
          </div>
          ...
          <div class="lt-form-group">
            ...
            <div class="lt-input-wrap">
              <input type="password" id="lt-password" name="password"
                class="lt-input has-icon" placeholder="Enter your password or PIN"
                autocomplete="current-password" required aria-required="true"/>
              <button type="button" id="lt-eye-btn" class="lt-eye-btn" aria-label="Show password"></button>
            </div>
          </div>
          ...
          <button type="button" class="lt-btn-create-business"
            onclick="window.location.href='../LionTech_Complete_MVP_Remaining_Pages/subscription_plans.php';">
            ...
            <span data-lt="create_business">Créer mon espace entreprise</span>
          </button>

          <div class="lt-links">
            <a class="lt-link" href="forgot_password.php" data-lt="forgot">Forgot password?</a>
            <a class="lt-link"
      ...
      <div class="lt-right-footer">
        <span data-lt="footer_copy">© 2026 Tally. All rights reserved.</span>
        <div class="lt-footer-links">
          <a href="politique_copyright.php" data-lt="footer_privacy">Privacy Policy</a>
          <a href="condition_policy.php" data-lt="footer_terms">Terms of Service</a>
        </div>
      </div>
