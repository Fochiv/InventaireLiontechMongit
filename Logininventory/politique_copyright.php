<?php
/* ============================================================
   policy.php — Tally Business Manager
...
<div class="wrap">
  ...
  <div class="toc">
    <div class="toc-title"><span class="icon-list">≡</span> Table des matières</div>
  ...
  <div class="section" id="s1">
    ...
    <p>Tally Business Manager collecte les données suivantes pour faire fonctionner la plateforme :</p>
    <ul>
  ...
  <div class="section" id="s2">
    <h2><span class="icon-gear">⚙</span> 2. Utilisation des données</h2>
    <p>Les données collectées sont utilisées uniquement pour :</p>
    <ul>
      <li>Faire fonctionner et améliorer la plateforme Tally Business Manager.</li>
  ...
  <div class="section" id="s3">
    <h2><span class="icon-users">◎</span> 3. Responsabilités des parties</h2>
    ...
    <div class="alert-warn"><span class="icon-warn">⚠</span> <strong>Important :</strong> LionTech ne tient pas de contrat direct avec les employés ou managers. Le propriétaire du business est l'unique responsable contractuel vis-à-vis de LionTech.</div>
  </div>

  <div class="section" id="s4">
    <h2><span class="icon-card">▬</span> 4. Abonnement et paiement</h2>
    <p>Tally Business Manager propose les formules d'abonnement suivantes :</p>
    <ul>
    ...
    <p><strong>Méthodes de paiement acceptées :</strong> 🟠 Orange Money · 🟡 MTN Mobile Money · 🏦 Virement bancaire · <span class="icon-money">&#36;</span> Espèces (auprès d'un agent LionTech).</p>
  ...
  <div class="section" id="s5">
    <h2><span class="icon-lock">🔒</span> 5. Désactivation et réactivation</h2>
    <div class="alert-warn">
      <span class="icon-warn">⚠</span> <strong>Clause importante — Non-paiement :</strong><br/><br/>
    ...
    <div class="fee-box">
      <div class="fee-icon"><span class="icon-money">&#36;</span></div>
      <div>
  ...
  <div class="section" id="s6">
    <h2><span class="icon-lock"><span class="icon-lock">🔒</span></span> 6. Sécurité des données</h2>
    <ul>
  ...
  <div class="section" id="s7">
    <h2><span class="icon-shield">⛉</span> 7. Confidentialité</h2>
  ...
  <div class="section" id="s9">
    <h2><span class="icon-door">▭</span> 9. Résiliation</h2>
  ...
  <div class="section" id="s10">
    <h2><span class="icon-ok">✓</span> 10. Vos droits</h2>
  ...
  <div class="section" id="s11">
    <h2><span class="icon-phone">☎</span> 11. Nous contacter</h2>
    <a class="wa-btn" href="https://wa.me/237688203095?text=Bonjour%20LionTech%2C%20j'ai%20une%20question%20concernant%20votre%20politique." target="_blank" rel="noopener"><span class="icon-msg">▷</span> Contacter LionTech sur WhatsApp</a>
  ...
  <div class="toc">
    <div class="toc-title"><span class="icon-list">≡</span> Table of Contents</div>
  ...
  <div class="section" id="s2">
    <h2><span class="icon-gear">⚙</span> 2. How We Use Data</h2>
    <ul>
      <li>Operate and improve the Tally Business Manager platform.</li>
  ...
  <div class="section" id="s3">
    <h2><span class="icon-users">◎</span> 3. Responsibilities</h2>
    ...
    <div class="alert-warn"><span class="icon-warn">⚠</span> <strong>Important:</strong> LionTech does not hold a direct contract with employees or managers. The business owner is the sole contractual party with LionTech.</div>
  </div>

  <div class="section" id="s4">
    <h2><span class="icon-card">▬</span> 4. Subscription & Payment</h2>
    <ul>
    ...
    <p><strong>Accepted methods:</strong> 🟠 Orange Money · 🟡 MTN Mobile Money · 🏦 Bank transfer · <span class="icon-money">&#36;</span> Cash (LionTech agent).</p>
  ...
  <div class="section" id="s5">
    <h2><span class="icon-lock">🔒</span> 5. Deactivation & Reactivation</h2>
    <div class="alert-warn">
      <span class="icon-warn">⚠</span> <strong>Important Clause — Non-Payment:</strong><br/><br/>
  ...
  <div class="section" id="s6">
    <h2><span class="icon-lock"><span class="icon-lock">🔒</span></span> 6. Data Security</h2>
    <ul>
  ...
  <div class="section" id="s7">
    <h2><span class="icon-shield">⛉</span> 7. Privacy</h2>
  ...
  <div class="section" id="s9">
    <h2><span class="icon-door">▭</span> 9. Termination</h2>
  ...
  <div class="section" id="s10">
    <h2><span class="icon-ok">✓</span> 10. Your Rights</h2>
  ...
  <div class="section" id="s11">
    <h2><span class="icon-phone">☎</span> 11. Contact Us</h2>
    <a class="wa-btn" href="https://wa.me/237688203095?text=Hello%20LionTech%2C%20I%20have%20a%20question%20about%20your%20policy." target="_blank" rel="noopener"><span class="icon-msg">▷</span> Contact LionTech on WhatsApp</a>
...
<footer class="footer">
  <div>© <?= $year ?> Tally Business Manager. <?= $lang==='fr'?'Tous droits réservés.':'All rights reserved.' ?></div>
